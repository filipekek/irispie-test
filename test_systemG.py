...
#        print(x)
#        x += 1
        assertion(list(s0.F[i])[num], derivatives[i])

def derivatives0(s0, asgn):
    derivatives = [
    0,
    0,
    0
...
def derivatives3(s0, asgn):
    derivatives = [
    0,
    0,
    0
]
    loop(s0, derivatives, 3)

def derivatives4(s0, asgn):
    derivatives = [
    numpy.exp(asgn['r'],
    0,
    0
]
    loop(s0, derivatives, 4)

def derivatives5(s0, asgn):
    derivatives = [
    0,
    asgn['k'],
    0
]
    loop(s0, derivatives, 5)

def derivatives6(s0, asgn):
    derivatives = [
    -(asgn['obs_y'],
    0,
    0
]
    loop(s0, derivatives, 6)

def derivatives7(s0, asgn):
    derivatives = [
    0,
    asgn['c'],
    0
]
    loop(s0, derivatives, 7)

def derivatives8(s0, asgn):
    derivatives = [
    numpy.exp(asgn['r'])*asgn['y'],
    0,
    0
]
    loop(s0, derivatives, 8)

def derivatives9(s0, asgn):
    derivatives = [
    0,
    0,
    0
]
    loop(s0, derivatives, 9)

def derivatives10(s0, asgn):
    derivatives = [
    0,
    0,
    0
]
    loop(s0, derivatives, 10)

def derivatives11(s0, asgn):
    derivatives = [
    0,
    0,
    0
]
    loop(s0, derivatives, 11)


def derivatives12(s0, asgn):
    derivatives = [
    0,
    0,
    0
]
    loop(s0, derivatives, 12)

if __name__ == '__main__':
    derivatives0(s0, asgn)
    derivatives1(s0, asgn)
    derivatives2(s0, asgn)
    derivatives3(s0, asgn)
    derivatives4(s0, asgn)
    derivatives5(s0, asgn)
    derivatives6(s0, asgn)
    derivatives7(s0, asgn)
    derivatives8(s0, asgn)
    derivatives9(s0, asgn)
    derivatives10(s0, asgn)
    derivatives11(s0, asgn)
    derivatives12(s0, asgn)
