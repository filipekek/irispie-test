...
s = md.Source.from_lists(
    ...
    measurement_shocks=["shock_obs_i", "shock_obs_c", "shock_obs_a"],
    ...
    measurement_equations=[
        "i*obs_y = y*exp(r) + shock_obs_i*3",
        "obs_c*1 = c*k*shock_obs_c",
        "obs_i+2 = i + shock_obs_a",
    ],
)
...
#        print(x)
#        x += 1
        assertion(list(s0.J[i])[num], derivatives[i])
